        ...
        <div className="bg-white/90 backdrop-blur py-8 px-4 shadow-xl rounded-2xl ring-1 ring-black/5 sm:px-10">
          ...
          <div className="mb-6">
            <button
              ...
              className="w-full flex justify-center items-center px-4 py-2 border border-slate-200 rounded-full shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900"
            >
